...
//	echo 'Connected successfully';
	...
	$query = "
	SELECT id as AwardID, CONCAT('$',FORMAT(amount,0)) as AwardAmount, firstname as FirstName, lastname as LastName, role as Role, year as Year
		FROM (
			SELECT award_id, firstname, lastname, role 
			FROM nih_awardinvestigators
			WHERE lastname = '".$lastname."' and (firstname like '".$firstname_M."' OR firstname like '".$M_firstname."' OR firstname = '".$firstname."')
